...
class AntreanReferensiController extends Controller
{
    ...
    {
        return $this->client->call('antrean_fktp', 'GET', 'referensi/poli');
    }

    public function dokter(string $kodepoli, string $tanggal)
    {
        return $this->client->call('antrean_fktp', 'GET', "referensi/dokter/{$kodepoli}/{$tanggal}");
    }

    public function jadwalDokter(string $kodedokter, string $tanggal)
    {
        return $this->client->call('antrean_fktp', 'GET', "referensi/jadwaldokter/{$kodedokter}/{$tanggal}");
    }

    public function poliFingerPrint()
    {
        return $this->client->call('antrean_fktp', 'GET', 'referensi/poli/fingerprint');
    }

    public function pasienFingerPrint(string $norm)
    {
        return $this->client->call('antrean_fktp', 'GET', "referensi/pasien/fingerprint/{$norm}");
    }
}
