...
class AntreanLaporanController extends Controller
{
    ...
    {
        return $this->client->call('antrean_fktp', 'GET', "antrean/tanggal/{$tanggal}/{$kodepoli}");
    }

    public function perKodeBooking(string $kodebooking)
    {
        return $this->client->call('antrean_fktp', 'GET', "antrean/kodebooking/{$kodebooking}");
    }

    public function belumDilayani(string $kodepoli)
    {
        return $this->client->call('antrean_fktp', 'GET', "antrean/belumdilayani/{$kodepoli}");
    }
