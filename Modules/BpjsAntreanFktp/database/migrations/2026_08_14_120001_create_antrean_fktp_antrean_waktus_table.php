...
return new class extends Migration
{
    ...
    {
        Schema::create('antrean_fktp_antrean_waktus', function (Blueprint $table) {
            $table->id();
            $table->foreignId('antrean_id')->constrained('antrean_fktp_antreans')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('antrean_fktp_antrean_waktus');
    }
};
