...
class StoreTranscranialDopplerWindowRequest extends FormRequest
{
    ...
    {
        return [
            'transcranial_doppler_examination_id' => 'required|integer',
            'window_site' => 'required|string|in:temporal,orbital,suboccipital,submandibular',
