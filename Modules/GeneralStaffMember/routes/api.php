...
Route::apiResource('staff-members', StaffMemberController::class)->names('generalstaffmember.staff-members')->parameters(['staff-members' => 'staffMember'])->only(['store', 'update', 'destroy'])->middleware(['auth:sanctum', 'role:petugas|admin']);
