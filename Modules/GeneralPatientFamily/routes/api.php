...
Route::apiResource('patientfamilies', PatientFamilyController::class)->names('generalpatientfamily.patientfamilies')->only(['store', 'update', 'destroy'])->middleware(['auth:sanctum']);
