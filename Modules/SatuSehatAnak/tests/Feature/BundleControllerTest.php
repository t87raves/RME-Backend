...
namespace Modules\SatuSehatAnak\Tests\Feature;
...
class BundleControllerTest extends TestCase
{
    ...
    private function bundle(): array
    {
        return [
            'resourceType' => 'Bundle',
            'type' => 'transaction',
            'identifier' => ['system' => 'http://sys-ids.kemkes.go.id/imunisasi', 'value' => 'IMU-0001'],
            'entry' => [
    ...
    public function test_it_submits_bundle_for_use_case(string $endpoint): void
    {
        ...
        $response = $this->postJson("/api/v1/satusehat/anak/{$endpoint}", $this->bundle());
    ...
    public static function useCaseEndpoints(): array
    {
        return [
            ...
            ['imunisasi/bundle'],
            ['gizi/bundle'],
            ['tumbuh-kembang/bundle'],
            ['pkpr/bundle'],
            ['imunisasi-covid19/bundle'],
        ];
    }
    ...
    public function test_it_rejects_bundle_without_resource_type(): void
    {
        ...
        $this->postJson('/api/v1/satusehat/anak/mtbs/bundle', ['entry' => []])->assertStatus(422);
    }

    public function test_guest_cannot_submit(): void
    {
        $this->postJson('/api/v1/satusehat/anak/mtbs/bundle', $this->bundle())->assertStatus(401);
    }
}
