...
Route::apiResource('doctor-medical-departments', DoctorMedicalDepartmentController::class)->names('generaldoctormedicaldepartment.doctor-medical-departments')->parameters(['doctor-medical-departments' => 'doctorMedicalDepartment'])->only(['store', 'update', 'destroy'])->middleware(['auth:sanctum', 'role:petugas|admin']);
